...
Since the guests may not all have the Flyer app on their phone, they will receive an SMS with a URL linking to a chat that gives them the option to vote. To ensure continued interaction, guests are prompted to download the app for more features on Flyer.'
            />
          </div>
        </div>
      </div>
