...
Customers can also find inspiration in the category blocks that helps them narrow their choice down. In a way, we’re the event planner who offers a number choices and guide you after to pick the perfect invitation.'
            />
            <Description
              title='Paper Browser'
...
When a user taps a card, this page is important in terms of education. Below the card view the user can download the iOS app to continue to customize and send the invitation/card. The detail view also provides a preview of the card package (card, envelope, liner), and pricing."
            />
          </div>
          <div className='col-10'>
